...
public class Gano_Ahorcado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gano_ahorcado);

        tv_palabra = (TextView) findViewById(R.id.textView_palabra_gano);
        tv_puntaje = (TextView) findViewById(R.id.textView_puntaje_gano);
